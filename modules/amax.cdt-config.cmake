if(AMAX_CDT_ROOT STREQUAL "" OR NOT AMAX_CDT_ROOT)
   set(AMAX_CDT_ROOT "@CDT_ROOT_DIR@")
endif()

list(APPEND CMAKE_MODULE_PATH ${AMAX_CDT_ROOT}/lib/cmake/amax.cdt)
if (NOT AMAX_WASM_OLD_BEHAVIOR STREQUAL "Off")
    set(AMAX_WASM_OLD_BEHAVIOR "On")
    include(AmaxWasmToolchain)
endif()
...
function(AMAX_CHECK_VERSION output version hard_min soft_max hard_max) # optional 6th argument for error message
...
endfunction(AMAX_CHECK_VERSION)
