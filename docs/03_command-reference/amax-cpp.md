---
content_title: amax-cpp tool
---

To manually compile the source code, use `amax-cpp` and `amax-ld` as if it were __clang__ and __lld__. All the includes and options specific to EOSIO and CDT are baked in.

```
USAGE: amax-cpp [options] <input file> ...
