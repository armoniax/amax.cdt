...
You can find the implementation of `eosio::binary_extension` in the `eosio.cdt` repository in file: `amax.cdt/libraries/eosiolib/core/eosio/binary_extension.hpp`.
