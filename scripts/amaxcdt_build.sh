...
if [ "$ARCH" == "Linux" ]; then
   ...
   case "$OS_NAME" in
      "Amazon Linux AMI"|"Amazon Linux")
         FILE="./scripts/amaxcdt_build_amazon.sh"
         CXX_COMPILER=g++
         C_COMPILER=gcc
      ;;
      "CentOS Linux")
         FILE="${REPO_ROOT}/scripts/amaxcdt_build_centos.sh"
         CXX_COMPILER=g++
         C_COMPILER=gcc
      ;;
      "elementary OS")
         FILE="${REPO_ROOT}/scripts/amaxcdt_build_ubuntu.sh"
         CXX_COMPILER=clang++-4.0
         C_COMPILER=clang-4.0
      ;;
      "Fedora")
         FILE="${REPO_ROOT}/scripts/amaxcdt_build_fedora.sh"
         CXX_COMPILER=g++
         C_COMPILER=gcc
      ;;
      "Linux Mint")
...
if [ "$ARCH" == "Darwin" ]; then
   ...
   FILE="${REPO_ROOT}/scripts/amaxcdt_build_darwin.sh"
