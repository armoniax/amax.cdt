...
mkdir -p ${PROJECT}/${VERSION}/opt/amax.cdt/lib/cmake
...
echo "class EosioCdt < Formula
   ...
   homepage \"${URL}\"
   revision 0
   url \"https://github.com/armoniax/amax.cdt/archive/v${VERSION}.tar.gz\"
   version \"${VERSION}\"
   ...
   bottle do
      root_url \"https://github.com/armoniax/amax.cdt/releases/download/v${VERSION}\"
